			...
			<div className='innerContainer'>
				...
				<h4>
					...
					<span className='author'>
						By Lorem Ipsum <span>•</span> 3 minutes read
					</span>
				</h4>
				...
				<p>
					...
					everytime you want something? Sounds like a dream, right? Well guess
					what, it is not a dream anymore! The solution to all your problems can
					now be traced back to barter.
				</p>
				<p>
				...
				<p>
					...
					need to look for long term and assuring solutions which can help us
					all in a sustainable manner because after all, we are all in this
					together.
				</p>
				<p>
				...
				<p>
					...
					can learn and unlearn to do things differently.
				</p>
				<p>
					Remember that your choice to barter is going to matter, always.
					Register your product, take your first step{' '}
					<span
